...
public final class ModBlockStateProvider extends BlockStateProvider {
    private static final ResourceLocation FULL_CASING_MODEL = API.resource("block/casing_all");
    private static final ResourceLocation EMPTY_CASING_MODEL = API.resource("block/casing_empty");
    private static final ResourceLocation MODULE_IN_CASING_MODEL = API.resource("block/casing_module");
    private static final ResourceLocation CONTROLLER_MODEL = API.resource("block/controller");
