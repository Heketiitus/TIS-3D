...
public final class ModItemModelProvider extends ItemModelProvider {
    ...
    private <T extends Item> void module(final DeferredHolder<Item, T> item, final String overlayTexture) {
        module(item, modLoc(overlayTexture));
    }

    private <T extends Item> void module(final DeferredHolder<Item, T> item, final ResourceLocation overlayTexture) {
